...
public class CuadroClasificacionDataSets {
	...
	private void initMaps() {
		...
		mapaDocumentacionesProcesoSolicitudes.put("D01", "01. Solicitud en el registro");
		mapaDocumentacionesProcesoSolicitudes.put("D02", "02. Documentación anexa");
		mapaDocumentacionesProcesoSolicitudes.put("D03", "03. Requerimiento de subsanación de la solicitud");
		mapaDocumentacionesProcesoSolicitudes.put("D04", "04. Anexo requerimiento minimis 2.0");
		mapaDocumentacionesProcesoSolicitudes.put("D05", "05. Informe propuesta de desistimiento");
		mapaDocumentacionesProcesoSolicitudes.put("D06", "06. Resolución de desistimiento");
		mapaDocumentacionesProcesoSolicitudes.put("D07", "07. Notificación de resolución de desistimiento");

		mapaDocumentacionesProcesoPreevaluaciontecnico = new LinkedHashMap<>();
		mapaDocumentacionesProcesoPreevaluaciontecnico.put("D01", "01. Informe técnico de evaluación del técnico y de la comisión");
		mapaDocumentacionesProcesoPreevaluaciontecnico.put("D02", "02. Propuesta de aprobado");
		mapaDocumentacionesProcesoPreevaluaciontecnico.put("D03", "03. Propuesta de denegado");

		mapaDocumentacionesProcesoComisionEvaluacionivace = new LinkedHashMap<>();
		mapaDocumentacionesProcesoComisionEvaluacionivace.put("D01", "01. Listado resumen de la instrucción para la comisión");
		mapaDocumentacionesProcesoComisionEvaluacionivace.put("D02", "02. Informe del jefe del área");
		mapaDocumentacionesProcesoComisionEvaluacionivace.put("D03", "03. Acta de la comisión");
		mapaDocumentacionesProcesoComisionEvaluacionivace.put("D04", "04. Propuesta para resolución (Consellerias)");
		mapaDocumentacionesProcesoComisionEvaluacionivace.put("D05", "05. Anexo con la lista de expedientes para resolución de concesión");
		mapaDocumentacionesProcesoComisionEvaluacionivace.put("D06", "06. Anexo con la lista de expedientes para resolución de denegación");

		mapaDocumentacionesProcesoResolucionconcesion = new LinkedHashMap<>();
		mapaDocumentacionesProcesoResolucionconcesion.put("D01", "01. Firma resolución de la ayuda");

		mapaDocumentacionesProcesoComunicacionconcesionabeneficiario = new LinkedHashMap<>();
		mapaDocumentacionesProcesoComunicacionconcesionabeneficiario.put("D01", "01. Comunicación de concesión de la ayuda");
		mapaDocumentacionesProcesoComunicacionconcesionabeneficiario.put("D02", "02.Comunicación de denegación de la ayuda");
		mapaDocumentacionesProcesoComunicacionconcesionabeneficiario.put("D03", "03. Anexo a la resolución de concesión Documento que establece las condiciones de la ayuda anexo");
		mapaDocumentacionesProcesoComunicacionconcesionabeneficiario.put("D04", "04. Notificación certificado de deducción fiscal");
		mapaDocumentacionesProcesoComunicacionconcesionabeneficiario.put("D05", "05. Anexo notificación certificado de deducción fiscal");

		mapaDocumentacionesProcesoAnticipoprestamo = new LinkedHashMap<>();
		mapaDocumentacionesProcesoAnticipoprestamo.put("D01", "01. Comunicación de concesión definitiva plurianuales");
		mapaDocumentacionesProcesoAnticipoprestamo.put("D02", "02. Comunicación de concesión condicionada de préstamos");
		mapaDocumentacionesProcesoAnticipoprestamo.put("D03", "03. Comunicación de concesión préstamos");
		mapaDocumentacionesProcesoAnticipoprestamo.put("D04", "04. Anexo a la notificación de concesión  para la aceptación de las condiciones del préstamo");
		mapaDocumentacionesProcesoAnticipoprestamo.put("D05", "05. Anexo a la notificación de concesión Instrucciones de presentación de garantía o aval");

		mapaDocumentacionesProcesoEjecuciondeproyecto = new LinkedHashMap<>();
		mapaDocumentacionesProcesoEjecuciondeproyecto.put("D01", "01. Solicitud de modificación por parte del beneficiario");
		mapaDocumentacionesProcesoEjecuciondeproyecto.put("D02", "02. Aprobación de modificación");
		mapaDocumentacionesProcesoEjecuciondeproyecto.put("D03", "03. Resolución de redistribución de costes");

		mapaDocumentacionesProcesoJustificacionproyecto = new LinkedHashMap<>();
		mapaDocumentacionesProcesoJustificacionproyecto.put("D01", "01. Presentación de la justificación");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D02", "02. Documentación anexa");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D03", "03. Comunicación recordando el plazo de justificación");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D04", "04. Diligencia de formalización de avales");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D05", "05. Informe del importe máximo endosable");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D06", "06. Informe comprobación validez del aval");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D07", "07. Diligencia de formalización de avales");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D08", "08. Anexo de incidencias de la verificación en la notificaicón de minoración revocación");
		mapaDocumentacionesProcesoJustificacionproyecto.put("D09", "09. Informe de propuesta de revocación sin verificación administrativa");

		mapaDocumentacionesProcesoVerificaciondocumental = new LinkedHashMap<>();
		mapaDocumentacionesProcesoVerificaciondocumental.put("D01", "01. Documentación justificativa");
		mapaDocumentacionesProcesoVerificaciondocumental.put("D02", "02. Informe técnico de la verificación administrativa del expediente");
		mapaDocumentacionesProcesoVerificaciondocumental.put("D03", "03. Conformidad");
		mapaDocumentacionesProcesoVerificaciondocumental.put("D04", "04. Propuesta de fase O para contabilizar");
		mapaDocumentacionesProcesoVerificaciondocumental.put("D05", "05. Requerimiento de subsanación de la solicitud");
		mapaDocumentacionesProcesoVerificaciondocumental.put("D06", "06. Notificación resolución de minoración");
		mapaDocumentacionesProcesoVerificaciondocumental.put("D07", "07. Anexo de incidencias subsanables para el requerimiento de subsanación de la verificacion");

		mapaDocumentacionesProcesoVerificacionmaterial = new LinkedHashMap<>();
		mapaDocumentacionesProcesoVerificacionmaterial.put("D01", "01. Informe técnico de verificación sobre el terreno del expediente");
		mapaDocumentacionesProcesoVerificacionmaterial.put("D02", "02. Conformidad");
		mapaDocumentacionesProcesoVerificacionmaterial.put("D03", "03. Requerimiento de subsanación de la solicitud");
		mapaDocumentacionesProcesoVerificacionmaterial.put("D04", "04. Notificación resolución de minoración");
		mapaDocumentacionesProcesoVerificacionmaterial.put("D05", "05. Anexo de incidencias subsanables para el requerimiento de subsanación de la verificacion");

		mapaDocumentacionesProcesoVerificacionfinal = new LinkedHashMap<>();
		mapaDocumentacionesProcesoVerificacionfinal.put("D01", "01. Informe técnico de la verificación final del expediente");
		mapaDocumentacionesProcesoVerificacionfinal.put("D02", "02. Anexo con la lista de expedientes para resolución de revocación");
		mapaDocumentacionesProcesoVerificacionfinal.put("D03", "03. Notificación resolución de revocación");
		mapaDocumentacionesProcesoVerificacionfinal.put("D04", "04. Informe técnico de propuesta de renuncia");
		mapaDocumentacionesProcesoVerificacionfinal.put("D05", "05. Anexo que lista los expedientes para la resolución de renuncia");
		mapaDocumentacionesProcesoVerificacionfinal.put("D06", "06. Resolución de renuncia");
		mapaDocumentacionesProcesoVerificacionfinal.put("D07", "07. Notificación de resolución de renuncia");
		mapaDocumentacionesProcesoVerificacionfinal.put("D08", "08. Anexo con la lista de expediente para la resolución de minoración");
		mapaDocumentacionesProcesoVerificacionfinal.put("D09", "09. Informe técnico de la verificación posterior a la final del expediente");

		mapaDocumentacionesProcesoComunicacionserviciopago = new LinkedHashMap<>();
		mapaDocumentacionesProcesoComunicacionserviciopago.put("D01", "01. Informe técnico para pago por anticipo");
		mapaDocumentacionesProcesoComunicacionserviciopago.put("D02", "02. Propuesta de fase K para contabilizar");
		mapaDocumentacionesProcesoComunicacionserviciopago.put("D03", "03. Propuesta de fase OK para contabilizar");

		mapaDocumentacionesProcesoPagosubvencion = new LinkedHashMap<>();
		mapaDocumentacionesProcesoPagosubvencion.put("D01", "01. Ratificación de endoso");
		mapaDocumentacionesProcesoPagosubvencion.put("D02", "02. Comunicación importe de ayuda tras su verificación");
		...
		mapaProcesos.put("P01", "01. Solicitudes");
		mapaProcesos.put("P02", "02. Pre-evaluación técnico");
		mapaProcesos.put("P03", "03. Comisión evaluación IVACE");
		mapaProcesos.put("P04", "04. Resolución concesión");
		mapaProcesos.put("P05", "05. Comunicación concesión a beneficiario");
		mapaProcesos.put("P06", "06. Anticipo o Préstamo");
		mapaProcesos.put("P07", "07. Ejecución del proyecto (modificaciones)");
		mapaProcesos.put("P08", "08. Justificación del proyecto");
		mapaProcesos.put("P09", "09. Verificación documental");
		mapaProcesos.put("P10", "10. Verificación material");
		mapaProcesos.put("P11", "11. Verificación final");
		mapaProcesos.put("P12", "12. Comunicación al servicio de pago");
		mapaProcesos.put("P13", "13. Pago subvención");
